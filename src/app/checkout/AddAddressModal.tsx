...
const AddAddressModal: React.FC<Props> = ({ closeModal, isForBillingAddress, onAddressAdded }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-4 sm:p-8 flex flex-col justify-between z-50 rounded-xl max-w-full sm:max-w-lg mx-4 max-h-[80vh] overflow-y-auto">
          ...
          <div className="mb-4">
            <div className="relative">
              <input
                id="full_address"
                className={`block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border appearance-none ${
                  formik.errors.full_address ? 'border-red-500' : 'border-gray-300'
                } focus:outline-none focus:ring-0 focus:border-rose-400 peer`}
                type="text"
                placeholder=" "
