  ...
  return (
    <div className="flex flex-col lg:w-[50rem] md:w-[30rem] sm:w-[30rem] gap-5">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center border border-gray-200 p-4 rounded-md justify-between">
        <label htmlFor="paypalPayment" className="flex gap-2 cursor-pointer font-medium">
            <Image src="/images/other/paypal-icon.png" alt="PayPal" width={30} height={30} objectFit="fill" />
            PayPal
        </label>
        <input
            type="radio"
        ...
        <div className="flex items-center border border-gray-200 p-4 rounded-md justify-between">
        <label htmlFor="stripePayment" className="flex gap-2 cursor-pointer font-medium">
            <Image src="/images/other/stripe-icon.png" alt="Stripe" width={30} height={30} objectFit="fill" />
      ...
      <button
        ...
        disabled={!selectedShippingAddress || !selectedBillingAddress || !isValidTotalCart || !selectedPaymentMethod}
      >
        Place Order
      </button>
    </div>
