...
const Page: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("Error updating PAN:", error.response.data);
      setPanError("Already Existing PAN or Please try again.");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="flex w-full items-center justify-center p-4">
        <div className="w-full max-w-xl rounded-lg bg-white p-6 md:p-10">
          ...
          <p className="mb-4 text-center text-sm text-gray-600">
            Thank you for your interest in our services. Please update the PAN to
            proceed.
          </p>
            ...
            <div>
              ...
              <input
                ...
                className={`mt-1 block w-full rounded-md border px-4 py-2 text-gray-700 shadow-sm focus:ring-[#bb547d] ${
                  panError ? "border-red-500 focus:border-red-500" : "border-gray-300 focus:border-[#f05794]"
                }`}
              />
              {panError && (
