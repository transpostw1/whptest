  ...
  return (
    <div className="flex flex-col items-center justify-between bg-gradient-to-r from-pink-100 to-gray-100 md:flex-row">
      <div className="md:w-1/2">
        ...
        <div className="px-7">
        <h2 className=" md:py-5 py-5 md:text-[55px] text-4xl leading-tight md:leading-[65px]">
        ...
        <div>
          ...
          <div className="py-4">
            <h1 className="text-start text-xl font-semibold text-red-950">
              Gold Exchange
            </h1>
            <p className="text-left font-normal text-red-950 py-1">
