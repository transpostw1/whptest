...
const GoldScheme = () => {
  ...
  return (
    <>
      ...
      <div className="mt-5  text-rose-950">
        <div className="lg:pl-7 grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1  ">
          <div className="px-8 lg:px-0">
            <h2 className="max-sm:text-center  font-semibold">GOLD MONTHLY SCHEME</h2>
            ...
            <p className="text-rose-950 text-center lg:text-left md:text-left">
              Invest in timeless wealth with our Gold Scheme, catering to a wide range of budgets. Making gold investment accessible to everyone. Watch your savings grow as you accumulate one of the most enduring
              assets.
            </p>
            ...
            <Link className=" lg:pb-10 text-center lg:text-left md:justify-start inline-flex w-full justify-center" href="/benefit">
              <button
                type="button"
