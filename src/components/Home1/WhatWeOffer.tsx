                ...
                <div className='flex flex-wrap'>
                    ...
                    <div className='w-full flex flex-col sm:w-[50%] p-4 sm:p-[4rem]'>
                        <div>
                            ...
                            <p className='text-sm md:text-base'>Discover our offerings. Our commitment to quality, elegance, and personalised service ensures an exceptional experience.</p>
                        </div>
                        <div className='mt-auto flex-end'>
                            <div className='flex justify-between'>
                                <div>
                                    ...
                                    <p className='text-sm md:text-base'>Elevate your style with our distinctive jewellery designs, where creativity and craftsmanship unite.</p>
