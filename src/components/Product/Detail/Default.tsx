...
const Default: React.FC<Props> = ({ productId }) => {
  ...
  //         </>
  //         <>
  //         <video className="w-[720px] h-[720px]" src="/products/GERD23021256.mp4" loop autoPlay controls/>
  //         </>
  //       </div>
  //       <div className="w-[50%]">

  //       {/* <div className="flex justify-between lg:w-[100%] sm:w-[20%]">
  //           <p className="font-bold text-3xl mb-5">{data?.Title}</p>
  //           <span className="rounded-full bg-[#e26178] p-3">
  //             <span className="text-white">
  //               <Icon.ShareFat weight="fill" size={30} />
  //             </span>
  //           </span>
  //       </div> */}
  //       </div>
    ...
    <>
      <div className="lg:flex">
        ...
        <div className="lg:w-[50%] sm:w-[100%] lg:mt-20 sm:mt-10 lg:ml-[45px] sm:m-auto">
          <div className="flex justify-between lg:w-[100%] sm:w-[20%]">
            <p className="font-semibold text-3xl mt-4 w-[357px]">
              {data?.Title}
            </p>
          ...
          <div className="mb-5">
            <span className="font-extrabold text-2xl">₹{data?.ProdPrice}</span>
            <span className="line-through ml-3 text-[#c5b8b8]">
              ₹{data?.ProdPriceWithTax}
            </span>
            ...
            <div className="p-4 border-t-2 border-[#f7f7f7]">
              ...
              {showAccordian === 2 ? (
                <div>
                  ...
                  <div className="grid grid-cols-4 mt-4 w-[70%]">
                    <div className="p-2">
