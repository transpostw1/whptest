...
const Product: React.FC<ProductProps> = ({ data, type }) => {
  ...
  //     if (compareState.compareArray.some((item) => item.ProductID === data.ProductID)) {
      ...
      <div className="product-item grid-type">
        ...
        >
          <div className="product-thumb bg-white relative overflow-hidden">
            ...
            {/* {data.sale&&(<div className="product-tag text-black bg-transparent px-3 py-0.5 inline-block  absolute top-3 left-3 z-[1] border">
          ...
          <div className=" mt-4 lg:mb-7">
            ...
            <div className="product-name text-title duration-300 text-xl">
              <p>{data.Title}</p>
              <p className="text-[#d8d8d8]">{data.ShortDesp}</p>
            </div>
            <div className="flex">
...
>>>>>>> 95065d20c2b33f180fb0f7befc36c17e0b5ea2d1
  );
};
