...
const VideoFeed = ({ videos, products }) => {
    ...
    const swipeHandlers = useSwipeable({
        onSwipedUp: () => setCurrentIndex([currentIndex + 1 < videos.length ? currentIndex + 1 : 0, 1]),
        onSwipedDown: () => setCurrentIndex([currentIndex - 1 >= 0 ? currentIndex - 1 : videos.length - 1, -1]),
